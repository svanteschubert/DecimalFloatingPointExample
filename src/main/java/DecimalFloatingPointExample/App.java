...
public class App {
    ...
    public static void main(String[] args) {        
        ...
        System.out.println("\tDECIMAL-32: Divide 1 by 900 =");
        System.out.println("\t\t" + new BigDecimal(1, mc1).divide(new BigDecimal(900, mc1), mc1));
        System.out.println("\tDECIMAL-32: Divide 1000000000 by 9 =");
        ...
        System.out.println("\tDECIMAL-64: Divide 1 by 900 =");
        System.out.println("\t\t" + new BigDecimal(1, mc2).divide(new BigDecimal(900, mc1), mc2));
        System.out.println("\tDECIMAL-64: Divide 1000000000 by 9 =");
        ...
        System.out.print("\tDECIMAL-128: Divide 1 by 900 =");
        System.out.println(new BigDecimal(1, mc3).divide(new BigDecimal(900, mc1), mc3));
        System.out.println("\tDECIMAL-128: Divide 1000000000 by 9 =");
        System.out.println("\t\t" + new BigDecimal(1000000000, mc1).divide(new BigDecimal(9, mc1), mc3));

// Switch rounding by parameter:        
//        System.out.println(d3 + " " + d3.setScale(8, RoundingMode.HALF_UP));
//        System.out.println(d3 + " " + d3.setScale(8, RoundingMode.HALF_EVEN));
 ...
 *
        ...
        System.out.println("UNLIMITED: Divide 1 by 900");
        System.out.println(new BigDecimal(1, mc4).divide(new BigDecimal(900, mc4), mc4));
        System.out.println("UNLIMITED: Divide 1000000000 by 9");
